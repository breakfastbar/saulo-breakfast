...
a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para classificar ascendente coluna",sSortDescending:": activar para classificar a coluna descendente"},
oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Sem dados disponíveis",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Exibindo 0 a 0 de 0 entradas",sInfoFiltered:"(filtrada a partir de _MAX_  entradas totais)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibindo _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Procurando...",sSearch:"Procurar:",sSearchPlaceholder:"Informe uma descrição",sUrl:"",sZeroRecords:"Nenhum registro correspondente encontrado"},oSearch:h.extend({},
